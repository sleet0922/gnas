...
class _DashboardPageState extends State<DashboardPage>
  ...
  Widget _buildAIStatusCard(ThemeData theme) {
    final ai = _info?.ai;
    return Card(
      child: Padding(
        padding: const EdgeInsets.all(16),
  ...
  Widget _buildServiceStatusRow(
    ...
    final detail = service?.message ?? '暂无状态';
    final extra = service?.device ?? service?.version;
    return Row(
      children: [
